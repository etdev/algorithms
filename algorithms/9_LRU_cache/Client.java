...
/*
    ...
    l.add(5);
    System.out.println("After adding 5:" + l.toString());
    LinkedList.Node removed = l.removeFirst();
    System.out.println("After removing first: " + l.toString());
    System.out.println("And the removed element: " + removed.toString());
*/
